...
나의 로직을 뽑내면서 많은사람들이 저의 로직에 굴복 하여야 한다는 정도로 잘하지 않는점을 제가더 잘 알고 있는것같습니다.
vercel 오픈 소스도 힘들게 읽는저로서는, 로직을 땅에서 처음부터 끝까지 치는게아니라
 다른사람이 만들어둔 로직에서 추가적인것을 얼마나자 잘 할 수 있는지가 더중요하다고 생각하여,
 이러한 형식에 포토폴리오로 기술을 추가공부 하여서 올렸지만,
 매우가성비가안좋네요.(3개월 공부하고 1페이지 올라가고) 그래도 쉬운페이지를 많이추가하는것은 바람직하지 않다고 생각하여, 생각한것중 아이거 정말 힘들겠구나
 하는것만 추가하고있습니다.
  <br><br> <br><br>
