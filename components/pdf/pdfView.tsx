...
const PdfView = ({ page }: Props) => {
  ...
  return (
    <>
      ...
      <div
        className="  pt-5 h-90vh overflow-scroll bg-slate-50"
        ref={PdfSizeRef}
      >
        <Document
          file={url}
        ...
        >
          <div className="flex">
            <Page
              ...
              onRenderSuccess={() => {
                const textContentElements = document.querySelectorAll(
                  ".react-pdf__Page__textContent"
                ) as NodeListOf<HTMLDivElement>;
                const annotationsElements = document.querySelectorAll(
                ...
                onRenderSuccess={() => {
                  if (prevPageNumber !== ReduxpageNumber) {
                    ...
                    const prevPageElements = document.querySelectorAll(
                      `.react-pdf__Page__textContent[data-page-number="${
                        prevPageNumber + 1
                      }"], .react-pdf__Page__annotations[data-page-number="${
                        prevPageNumber + 1
                      }"]`
                    ) as NodeListOf<HTMLDivElement>;
