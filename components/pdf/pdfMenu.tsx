...
function PdfMenu({ getPage }: Props) {
  const {
    upNumPages: disposeupNumPages,
    downNumPages: disposedownNumPages,
    setPageNumber: disposesetPageNumber,
    downPageScale: disposedownPageScale,
    upPageScale: disposeupPageScale,
  } = pdfActions;
  const { pageNumber: ReduxpageNumber, pageScale: ReduxpageScale } =
          ...
          <div className="flex justify-end items-center">
            ...
            <div className="flex items-center mr-3">
              ...
              <button
                ...
                onClick={() => {
                  pageMax - 1 < pageNumber
                    ? pageNumber
                    : dispatch(disposeupNumPages(getPage));
                }}
              >
                Next
              </button>
              ...
              <button
                ...
                onClick={() => {
                  pageNumber - 1 < 2
                    ? pageNumber
                    : dispatch(disposedownNumPages(getPage));
                }}
              >
                Prev
              </button>
            ...
            <div className="flex items-center">
              ...
              <button
                ...
                onClick={() => {
                  pageScale - 0.1 < 0.1
                    ? 0.1
                    : dispatch(disposeupPageScale(0.1));
                }}
              >
                +
              </button>
              <button
                ...
                onClick={() => {
                  pageScale - 0.1 < 0.1
                    ? 0.1
                    : dispatch(disposedownPageScale(0.1));
                }}
              >
                -
              </button>
